...
def Q1a():
    return Configuration().setParameter('yAxisColor', [0,1,1]).display()
...
def Q4a():
    ...
    wall1 = Wall({'position':[-3,1,0], 'width':6, 'height':3, 'orientation':0})
    wall2 = Wall({'position':[-3,1,0], 'width':3, 'height':3, 'orientation':90})
    wall3 = Wall({'position':[-3,4,0], 'width':6, 'height':3, 'orientation':0})
    wall4 = Wall({'position':[3,1,0], 'width':3, 'height':3, 'orientation':90})  
